...
process download_repeat_annotation
{
    ...
    shell:
        ...
        '''
            ...
            cat !{regions} \
            | awk -F"\\t" '{print \
$1"\\tT2T_rmsk\\tgene\\t"$2"\\t"$3"\\t"$5"\\t"$6"\\t.\\tgene_id \\""$4"\\"; transcript_id \\""$4"_range="$1":"$2"-"$3"_strand="$6"\\"; gene_type \\""$8","$7"\\";\\n"\
$1"\\tT2T_rmsk\\ttranscript\\t"$2"\\t"$3"\\t"$5"\\t"$6"\\t.\\tgene_id \\""$4"\\"; transcript_id \\""$4"_range="$1":"$2"-"$3"_strand="$6"\\"; gene_type \\""$8","$7"\\";\\n"\
$1"\\tT2T_rmsk\\texon\\t"$2"\\t"$3"\\t"$5"\\t"$6"\\t0\\tgene_id \\""$4"\\"; transcript_id \\""$4"_range="$1":"$2"-"$3_strand"="$6"\\";  gene_type \\""$8","$7"\\"; exon_number \\"1\\";"}' \
            | gzip --best \
